  ...
  return (
    ...
    >
      <div className="site-container-wide py-10">
        <div className="hud-corners grid grid-cols-2 gap-y-8 text-gold-500 lg:grid-cols-4 lg:divide-x lg:divide-ink-700">
          <div className="px-2 lg:px-8 lg:first:pl-0">
            <p className={numeralClass}>
              <Counter to={rating} decimals={1} />{" "}
              <Star
                aria-hidden="true"
                className="inline h-5 w-5 fill-star text-star align-baseline"
              />
            </p>
